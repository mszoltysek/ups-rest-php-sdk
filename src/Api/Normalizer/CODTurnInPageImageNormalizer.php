...
class CODTurnInPageImageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $class, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \ShipStream\Ups\Api\Model\CODTurnInPageImage();
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\CODTurnInPageImage' => false);
    }
}