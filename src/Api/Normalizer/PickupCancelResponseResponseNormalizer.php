...
class PickupCancelResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ShipStream\\Ups\\Api\\Model\\PickupCancelResponseResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'ShipStream\\Ups\\Api\\Model\\PickupCancelResponseResponse';
    }
    /**
     * @return mixed
     */
    public function denormalize(mixed $data, string $class, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \ShipStream\Ups\Api\Model\PickupCancelResponseResponse();
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\PickupCancelResponseResponse' => false);
    }
}