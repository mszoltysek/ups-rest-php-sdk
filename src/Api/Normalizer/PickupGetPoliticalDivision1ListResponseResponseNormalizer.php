...
class PickupGetPoliticalDivision1ListResponseResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ShipStream\\Ups\\Api\\Model\\PickupGetPoliticalDivision1ListResponseResponse';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'ShipStream\\Ups\\Api\\Model\\PickupGetPoliticalDivision1ListResponseResponse';
    }
    /**
     * @return mixed
     */
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\PickupGetPoliticalDivision1ListResponseResponse' => false);
    }
}