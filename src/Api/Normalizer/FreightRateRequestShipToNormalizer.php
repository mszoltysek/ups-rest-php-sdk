...
class FreightRateRequestShipToNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ShipStream\\Ups\\Api\\Model\\FreightRateRequestShipTo';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'ShipStream\\Ups\\Api\\Model\\FreightRateRequestShipTo';
    }
    /**
     * @return mixed
     */
    public function denormalize(mixed $data, string $class, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('Address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['Address'], 'ShipStream\\Ups\\Api\\Model\\FreightRateShipToAddress', 'json', $context));
            unset($data['Address']);
        }
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\FreightRateRequestShipTo' => false);
    }
}