...
class ChemicalReferenceDataRequestRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ShipStream\\Ups\\Api\\Model\\ChemicalReferenceDataRequestRequest';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'ShipStream\\Ups\\Api\\Model\\ChemicalReferenceDataRequestRequest';
    }
    /**
     * @return mixed
     */
    ...
    public function normalize(mixed $object, ?string $format = null, array $context = []): \ArrayObject|array|string|int|float|bool|null
    {
        ...
        if ($object->isInitialized('requestOption') && null !== $object->getRequestOption()) {
            $values = array();
            foreach ($object->getRequestOption() as $value) {
                $values[] = $value;
            }
            $data['RequestOption'] = $values;
        }
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\ChemicalReferenceDataRequestRequest' => false);
    }
}