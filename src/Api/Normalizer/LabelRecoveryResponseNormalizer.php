...
class LabelRecoveryResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('LabelResults', $data)) {
            ...
            $tmp = is_array($data['LabelResults'][0] ?? null) ? $data['LabelResults'][0] : $data['LabelResults'];
            $object->setLabelResults($this->denormalizer->denormalize($tmp, 'ShipStream\\Ups\\Api\\Model\\LabelRecoveryResponseLabelResults', 'json', $context));
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\LabelRecoveryResponse' => false);
    }
}
