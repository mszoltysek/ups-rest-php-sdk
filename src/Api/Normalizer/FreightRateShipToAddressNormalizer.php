...
class FreightRateShipToAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ShipStream\\Ups\\Api\\Model\\FreightRateShipToAddress';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'ShipStream\\Ups\\Api\\Model\\FreightRateShipToAddress';
    }
    /**
     * @return mixed
     */
    public function denormalize(mixed $data, string $class, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \ShipStream\Ups\Api\Model\FreightRateShipToAddress();
    ...
    {
        return array('ShipStream\\Ups\\Api\\Model\\FreightRateShipToAddress' => false);
    }
}